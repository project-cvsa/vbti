...
export const questions: Question[] = [
	...
	},
	{
		...
		options: [
			...
			{
				label: "像《虽然歌声无形》里的初音未来，不执着于留住什么，只愿在歌声里温柔地走过一程。🎵",
				value: "N",
				lang: "JP",
			},
	...
	},
	{
		...
		options: [
			...
			{
				label: "《强风大背头》——即使风中凌乱，也就随遇而安吧，幽默和自嘲也能化为生活动力和创造力🌬️",
				value: "S",
				lang: "JP",
			},
			{
				label: "《天ノ弱》——胆怯孤单，说着反话，内心却渴望着有人能看穿它。🌧️",
				value: "IN",
				lang: "JP",
			},
		],
	...
	},
	{
		...
		options: [
			{
				label: "全场巡回集邮！能逮到的P主/UP主和coser全都要合影，能聊两句就更好了！📸",
				value: "EP",
			},
			{ label: "直奔喜欢的P主/UP主摊位买周边，买完安静逛两圈就撤。🛍️", value: "ITJ" },
	...
	{
		id: "q22",
		text: "你在B站刷到一个新的术力口企划/活动预告，你很喜欢它的主题，你会？",
		options: [
			{ label: "立刻关注官方/发起UP主的账号，研究预告，在评论区蹲后续消息。🔍", value: "J" },
			{ label: "先加进收藏夹或“稍后再看”，等正式发布了再慢慢品。📑", value: "P" },
			{ label: "把预告转到同好群或动态，和大家一起猜内容、讨论阵容。📢", value: "E" },
			{ label: "去搜这个企划里提到的P主和歌手，提前做功课，研究透了再跟进。📖", value: "J" },
		],
	},
	{
		id: "q23",
