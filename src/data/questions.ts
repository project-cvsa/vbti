...
export const questions: Question[] = [
	{
		...
		text: "你希望能召唤出哪种灵魂歌姬？",
		options: [
			{ label: "性格越像我越好！最好和我本人的MBTI一致", value: "S" },
			{ label: "和我爱听的术力口一致，是自推那更好啦~", value: "F" },
			{ label: "越冷门越特别！我就想看看小众或者之前不认识的！", value: "N" },
			{ label: "选到哪个是哪个，我都可以~", value: "P" },
		],
	},
	{
		id: "q1",
	...
	},
	{
		...
		options: [
			...
			{ label: "像巡音流歌那种，成熟优雅、从容不迫的人。🌙", value: "I", lang: "JP" },
		],
	},
	{
		id: "q4",
	...
	},
	{
		...
		options: [
			...
			{ label: "默默截图发到自己个人群：“快来看好戏。”📸", value: "T" },
	...
	},
	{
		...
		options: [
			{ label: "一段热血燃烧的副歌——V家就是我青春里的那团火。🔥", value: "E" },
			{ label: "一段温柔循环的间奏——不需要高潮，一直陪伴就已足够。🎧", value: "S" },
			{ label: "一段还未完成的demo——我和V家的故事才刚开始，未来可期。🌱", value: "P" },
			{ label: "一段复杂的变奏——从入坑到退坑再到回坑，兜兜转转还是这里。🔄", value: "J" },
		],
	},
	{
		id: "q39",
		...
		options: [
			{ label: "一定是那个最元气的角色！💪", value: "E" },
			{ label: "可能是那个温柔治愈的角色吧。🌸", value: "F" },
			{ label: "随便，测到什么是什么。🤷", value: "P" },
			{
