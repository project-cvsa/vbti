...
export const characters: Record<string, Character> = {
	初音未来: {
		...
		popularity: 100,
		mbti: "ENFP",
		desc: "你就像初音未来一般，是世界的焦点，也是创作的源泉，王牌般的主角。你有极强的共情能力和创造力，内心深处藏着理想主义的光芒。你温柔、敏感，有时会沉浸在自己的精神世界里，但一旦站上舞台，就能用你的方式感染所有人。你不需要刻意讨好谁，因为你本身就足够闪耀。无论是被人理解还是被人误解，你始终相信：音乐和真诚能跨越一切。✨",
	...
	重音Teto: {
		...
		popularity: 98,
		mbti: "ENFP",
		desc: '你的性格就像重音Teto，外表看似简单少女，实则是成熟奇美拉！Teto最初是2008年愚人节在2ch上被编造出来"钓鱼"的虚构角色，然而凭借独特的红色螺旋双马尾、呆毛和血红色瞳孔奇美拉的形象，以及粉丝们的热爱，她最终拥有了UTAU声库，直至今天的SV声库，变成了真正的虚拟歌手。你的人生可能也充满了反差与惊喜——别人以为你在开玩笑的时候，你已经悄悄地做到了别人做不到的事。从"愚人节玩笑"到"真正的歌姬"，你用行动证明了什么是逆袭，奇美拉占领世界！💥',
	...
	乐正绫: {
		...
		popularity: 90,
		mbti: "ESFP",
		desc: '你的性格和乐正绫如出一辙——活力四射，元气满满！平日里，她是活力十足的16岁女高中生，实际上，她还是乐器制造商和音乐大企业乐正集团的大小姐，声音元气，个性鲜明。你是一个行动派，想到什么就去做，从不拖泥带水。你直来直去，不喜欢拐弯抹角，虽然有时候会显得有点大大咧咧，但这份率真正是你最迷人的地方。你天生自带一种"大小姐"的气场，不是因为高傲，而是因为你足够自信和洒脱。你相信，人生就是要跑起来才精彩！🏃‍♀️',
	...
	乐正龙牙: {
		...
		popularity: 62,
		mbti: "INTJ",
		desc: "你的性格就像乐正龙牙，头脑清晰、洒脱利落，随性不羁的作风下藏着敏锐果决的洞察力。他是乐正绫的哥哥，乐正集团的未来当家，平时看起来有点嫌麻烦，但关键时刻总是他回来统筹全局、稳定军心。他是乐队的鼓手，演奏风格热血激烈——平时有多怕麻烦，拿起鼓槌的那一刻就有多投入。你也是如此：讨厌琐碎、不轻易出手，但一旦认真起来，整个局面的走向都在你的掌控之中。别人看到的是你的喜怒不形于色，真正懂你的人才知道——你只是把能量留给了值得的人和事。🐉",
	...
	墨清弦: {
		...
		popularity: 62,
		mbti: "INTP",
		desc: "你就像墨清弦，冷静、理性、知性优雅。墨清弦拥有紫色的长发和冷静沉稳的性格。她给人的第一印象可能是高冷、难以接近，但实际上只是习惯用理性的方式处理问题。你擅长分析、逻辑清晰，在混乱中能保持冷静的头脑。别人眼中的“高冷”，其实是你专注思考时的样子，当然也有可能是你反应“慢了半拍”。📚",
